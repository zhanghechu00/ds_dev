...
async def run_Petrel2Aifrac(query: str,file_name:str) -> str:
    ...
    if err!="":
        return err
    exe_path = r"C:\Users\HXfog04\Desktop\MYGPTAIv2\GRDECL_Parser.exe"
    try:
        DETACHED_PROCESS = 0x00000008
        process = subprocess.Popen(
...
async def run_Aifrac2Petrel(query: str) -> str:
    ...
    exe_path = r"C:\Users\HXfog04\Desktop\MYGPTAIv2\Gefrac2Petrel.exe"
    try:
        # Windows下DETACHED_PROCESS让子进程完全独立
        DETACHED_PROCESS = 0x00000008
        process = subprocess.Popen(
...
async def run_boundary(query: str,F:str) -> str:
    ...
    if err!="":
        return err
    exe_path = r"C:\Users\HXfog04\Desktop\MYGPTAIv2\boundary.exe"
    try:
        # Windows下DETACHED_PROCESS让子进程完全独立
        DETACHED_PROCESS = 0x00000008
        process = subprocess.Popen(
...
async def run_map2petrel(query: str,file_name:str) -> str:
    ...
    exe_path = r"C:\Users\HXfog04\Desktop\MYGPTAIv2\ExportPetroFileV32.exe"
    try:
        # Windows下DETACHED_PROCESS让子进程完全独立
        DETACHED_PROCESS = 0x00000008
        process = subprocess.Popen(
...
async def run_wellcalc(query: str,file_name:str) -> str:
    ...
    """
    exe_path = r"C:\Users\HXfog04\Desktop\MYGPTAIv2\welllog.exe"
